<?
    ...
    class ActionOnTrigger extends IPSModule {
        ...
        public function Create() {
            ...
            $this->checkScript("SetMyValue", "<?php SetValue(\$IPS_VARIABLE, \$IPS_VALUE); ?>", false);
...
// ------------------------------------------------------------------------------------------------------------
        ...
        protected function checkDimVar () {
            ...
            if($this->checkEIBDim() != false) {
                ...
                IPS_SetVariableCustomAction($this->searchObjectByName("Startwert"), $this->searchObjectByName("SetMyValue"));
...
// ------------------------------------------------------------------------------------------------------------
        ...
        public function addSwitch ($vid) {
            ...
            if(IPS_VariableProfileExists("Switch"))
            {
                ...
                IPS_SetVariableCustomAction($vid, $this->searchObjectByName("SetMyValue"));
